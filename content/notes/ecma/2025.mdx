...
[查看提案实现](https://github.com/tc39/proposal-json-modules)
...
2024年8月起在主要浏览器已实现： [查看兼容](https://caniuse.com/mdn-javascript_regular_expressions_named_capturing_group_duplicate_named_capturing_groups) [查看提案实现](https://github.com/tc39/proposal-duplicate-named-capturing-groups)
